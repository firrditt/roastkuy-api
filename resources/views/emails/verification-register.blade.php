...
<html lang="en">
  ...
  <body class="o_body o_bg-light" style="width: 100%;margin: 0px;padding: 0px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #dbe5ea;">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
      <tbody>
        <tr>
          <td class="o_hide" align="center" style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">Verifikasi Akun Anda</td>
        </tr>
      </tbody>
    </table>
    <!-- header -->
          ...
          <tr>
            <td class="o_bg-light o_px-xs o_pt-lg o_xs-pt-xs" align="center" style="background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;padding-top: 32px;">
              ...
              <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
                <tbody>
                  <tr>
                    <td class="o_bg-dark o_px o_py-md o_br-t o_sans o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color:  #FFA500;border-radius: 4px 4px 0px 0px;padding-left: 16px;padding-right: 16px;padding-top: 24px;padding-bottom: 24px;">
                      <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-white" href="#" style="text-decoration: none;outline: none;color: #ffffff;">
                          <img src="https://roastkuy.id/wp-content/uploads/2023/09/cropped-cropped-roastkuy-e1685173239534.png" width="250" height="36" style="max-width: 212px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a></p>
                    </td>
                  </tr>
                </tbody>
              </table>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
        <tbody>
            <tr>
                <!--[if mso]><table width="632" cellspacing="0" cellpadding="0" border="0" role="presentation"><tbody><tr><td><![endif]-->
                <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width:632px;margin:0 auto;background-color: white;">
                <tbody>
                    <tr>
                    <td class="o_bg-white o_px-md o_py-lg o_bt-light o_br-b o_sans o_text-xs o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ffffff #d3dce0;border-radius: 0px 0px 4px 4px;padding-left: 24px;padding-right: 24px;padding-top: 25px;padding-bottom: 25px;">
                        <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">Selamat Datang</p>
                        <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;color: #82899a;">
                            Terima kasih telah bergabung bersama kami. Berikut adalah OTP untuk verifikasi akun anda.</p>
                    </td>
                    </tr>
                </tbody>
                </table>
              ...
              <tbody>
                <tr>
                  <td class="o_bg-white o_px-md o_py o_sans o_text-xs o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ffffff;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;  text-align:center;"><strong>OTP</strong></p>
                      ...
                      <tbody>
                        <tr>
                          <td width="284" class="o_bg-ultra_light o_br o_text-xs o_sans o_px-xs o_py" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ebf5fa;border-radius: 4px;padding-left: 8px;padding-right: 8px;padding-top: 16px;padding-bottom: 16px;">
                            <p class="o_text-dark" style="color: #242b3d;margin-top: 0px;margin-bottom: 0px; text-align:center"><strong>{{ $otp }}</strong></p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    <p class="o_text-dark" style="color: #242b3d;margin-top: 0px;margin-bottom: 0px; text-align:center">OTP hanya berlaku selama 5 menit</p>
                  </td>
                </tr>
              </tbody>
            </table>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
        <tbody>
            <tr>
                ...
                <tbody>
                    <tr>
                        <td class="o_bg-white o_px-md o_py-lg o_bt-light o_br-b o_sans o_text-xs o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ffffff #d3dce0; border-radius: 0px 0px 4px 4px;padding-left: 24px;padding-right: 24px; padding-top: 10px">
                            <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;color: #82899a;">Untuk informasi lebih lanjut, silakan menghubungi admin Roastkuy melalui email <a href="mailto:roastkuy@gmail.com">
                                Roastkuy
                            </a></p>
                        </td>
                    </tr>
                    <tr>
                        <td class="o_bg-white o_px-md o_py-lg o_bt-light o_br-b o_sans o_text-xs o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ffffff #d3dce0; border-radius: 0px 0px 4px 4px;padding-left: 24px;padding-right: 24px; padding-top: 20px">
                            <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">Terima Kasih,</p>
                            <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">
                                <strong>Roastkuy</strong>
                            </p>
                        </td>
                    </tr>
                </tbody>
              ...
              <tbody>
                <tr>
                  <td class="o_bg-white o_px-md o_py-lg o_bt-light o_br-b o_sans o_text-xs o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ffffff;color: #82899a;border-top: 1px solid #d3dce0;border-radius: 0px 0px 4px 4px;padding-left: 24px;padding-right: 24px;padding-top: 32px;padding-bottom: 32px;">
                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px; text-align:center">©2024 Roastkuy</p>
                  </td>
                </tr>
              </tbody>
            </table>
